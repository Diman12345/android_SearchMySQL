...
public class MainActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener,
    ...
    public static final String url_data = "http://172.29.64.83/kuncoro_search_view/data.php";
    public static final String url_cari = "http://172.29.64.83/kuncoro_search_view/cari_data.php";
